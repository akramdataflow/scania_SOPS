...
class App(ttk.Frame):
    ...
    def on_modify_choice(self, event=None):
        choice = (self.var_modify.get() or "").strip().lower()
    ...
    def _action_retarder_disable(self): self._log("[ACTION] retarder disable (placeholder)")
    def _action_clutch_off(self):       self._log("[ACTION] clutch off (placeholder)")
    def _action_pto_type(self):         self._log("[ACTION] pto type (placeholder)")
    def _action_cyl_off_match_off(self):self._log("[ACTION] cylinder off match off (placeholder)")
    def _action_ess_off(self):          self._log("[ACTION] ess off (placeholder)")
    def _action_flight_off(self):       self._log("[ACTION] flight off (placeholder)")
